...
const controller = __importStar(require("../controller/communicate.controller"));
const uploadCloud_1 = require("../middleware/uploadCloud");
...
router.post("/groupChat", uploads.single('avatar'), uploadCloud_1.upload, controller.groupChatPost);
